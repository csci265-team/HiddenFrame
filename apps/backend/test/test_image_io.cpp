...
{
    image *test1 = new image("../../resources/images/test/input/test_image_2.png");
    BOOST_REQUIRE(test1 != nullptr);
    BOOST_TEST_MESSAGE("Test 2 - Loading PNG from File System - was successful.");
    test1->write_image("../../resources/images/test/output/test_image_2.png");
}
...
BOOST_AUTO_TEST_CASE(TestImageEmbeddingAndRetrieval)
{
    ...
    test5->modify_image(n, teststrBin);
